...
L.marker([-2027, 3384], {icon: cardIcon1}).addTo(map)
...
L.marker([-7174, 3160.75], {icon: cardIcon9}).addTo(map)
  .bindPopup("<h2>Airport 8</h3><p><a href='https://i.imgur.com/ud4EXp8.jpeg' data-lightbox='image-1' data-title='Airport 8'>Open In-Game Screenshot</a><div class='input-group input-group-sm mb-3'></div></div></p>");
...
L.marker([-1201.375, 3606.000], {icon: cardIcon57}).addTo(map)
  .bindPopup("<h2>Keycard 1</h3><p><a href='https://i.imgur.com/2oxwyWW.png' data-lightbox='image-1' data-title='Keycard 1'>Open In-Game Screenshot</a><div class='input-group input-group-sm mb-3'></div></div></p>");
