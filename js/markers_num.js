...
L.marker([-7230, 3988], {icon: cardIcon1}).addTo(map)
...
L.marker([-6787.25, 4595.25], {icon: cardIcon}).addTo(map)
...
L.marker([-5579.25, 2807], {icon: cardIcon}).addTo(map)
...
L.marker([-7297.75, 3667.5], {icon: cardIcon}).addTo(map)
...
L.marker([-7600, 6400], {icon: cardIcon}).addTo(map)
