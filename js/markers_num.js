...
L.marker([-6708, 3929.75], {icon: cardIcon9}).addTo(map)
  .bindPopup("<h2>Rancho 2</h3><p><a href='https://i.imgur.com/KBxmosq.jpg' data-lightbox='image-1' data-title='Rancho 2'>Open In-Game Screenshot</a><div class='input-group input-group-sm mb-3'></div></div></p>");
L.marker([-6760, 4058.75], {icon: cardIcon9}).addTo(map)
  .bindPopup("<h2>Rancho 6</h3><p><a href='https://i.imgur.com/EaAUZws.jpg' data-lightbox='image-1' data-title='Rancho 6'>Open In-Game Screenshot</a><div class='input-group input-group-sm mb-3'></div></div></p>");
...
L.marker([-6050, 4470], {icon: cardIcon8}).addTo(map)
  .bindPopup("<h2>Mirror Park 3</h3><p><a href='https://i.imgur.com/ZJImGvS.jpg' data-lightbox='image-1' data-title='Mirror Park 3'>Open In-Game Screenshot</a><div class='input-group input-group-sm mb-3'></div></div></p>");
...
L.marker([-2415, 4899], {icon: cardIcon4}).addTo(map)
  .bindPopup("<h2>Grapeseed 3</h3><p><a href='https://i.imgur.com/hdxNisj.png' data-lightbox='image-1' data-title='Grapeseed 3'>Open In-Game Screenshot</a><div class='input-group input-group-sm mb-3'></div></div></p>");
...
L.marker([-6669, 4446], {icon: cardIcon2}).addTo(map)
  .bindPopup("<h2>Cypress Flats 12</h3><p><a href='https://i.imgur.com/8I900cZ.png' data-lightbox='image-1' data-title='Cypress Flats 12'>Open In-Game Screenshot</a><div class='input-group input-group-sm mb-3'></div></div></p>");
...
L.marker([-3430, 5116], {icon: cardIcon4}).addTo(map)
  .bindPopup("<h2>Sandy Shores 6</h3><p><a href='https://i.imgur.com/D0FzuZR.png' data-lightbox='image-1' data-title='Sandy Shores 6'>Open In-Game Screenshot</a><div class='input-group input-group-sm mb-3'></div></div></p>");
...
L.marker([-4950, 3493], {icon: cardIcon3}).addTo(map)
  .bindPopup("<h2>Vinewood 3</h3><p><a href='https://i.imgur.com/S96mjWL.png' data-lightbox='image-1' data-title='Vinewood 3'>Open In-Game Screenshot</a><div class='input-group input-group-sm mb-3'></div></div></p>");
